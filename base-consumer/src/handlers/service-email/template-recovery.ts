...
<html lang="en" style="margin:0;padding:0;">
  <head>
    ...
    <title>MIDSO Account Recovery</title>
  </head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; margin:0 auto; background-color:#ffffff; border-radius:0px; overflow:hidden; box-shadow:0 0 8px rgba(0,0,0,0.05);">
      <tr>
        <td style="background-color:#2563eb; padding: 30px 20px; text-align:center;">
          <h1 style="color:#ffffff; margin:0;">MIDSO Account Recovery</h1>
        </td>
      </tr>
      <tr>
        <td style="padding:30px;">
          ...
          <p style="font-size:16px; color:#333;">
              We received a request to reset the password for your Midso account. If you made this request, you can reset your password by clicking the button below:
          </p>
